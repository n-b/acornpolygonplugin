...
- (void) registerIOProviderForReading:(<ACImageIOProvider>)provider forUTI:(NSString*)uti;
- (void) registerIOProviderForWriting:(<ACImageIOProvider>)provider forUTI:(NSString*)uti;
...
- (void) addLayer:(<ACLayer>)l atIndex:(int)idx;
