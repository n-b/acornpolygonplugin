...
/////////////////////////////////////////////////////////////////////////////////////////////
					...
					case 1032:
						...
						if(context->grid_guides.guide_count > 0)
						{
							...
							context->grid_guides.guide_coordinate = (psd_int *)psd_malloc(context->grid_guides.guide_count * sizeof(psd_int));
					...
					case 1050:
                        // there's also sometimes an 8.  wtf?
                        if (psd_stream_get_int(context) != 6) {
                            psd_stream_get_null(context, sizeofdata-32);
                            break;
                        }
...
#	endif // ifdef PSD_INCLUDE_LIBXML
                    ...
                    #warning this seems kinda broken?
